...
| `chmod 700 archivo` | permisos rwx solo para el dueño (grupo y otros sin acceso), comun para ~/.ssh y scripts privados |
...
| `ssh -i ruta-clave-ssh usuario@ip` | se conecta por ssh usando credenciales |
